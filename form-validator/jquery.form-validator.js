    ...
    $.formUtils = {
        ...
        defaultConfig :  function() {
            return {
                ...
                validationErrorMsgAttribute : 'data-validation-error', // define custom err msg inline with element
        ...
        validateInput : function($elem, language, conf, $form, eventContext) {
            ...
            $.split(validationRules, function(rule) {
                ...
                if( validator && typeof validator['validatorFunction'] == 'function' ) {
                    ...
                    if(!isValid) {
                        validationErrorMsg =  $elem.attr('data-' + rule.replace('validate_', 'validation-') + '-error');
